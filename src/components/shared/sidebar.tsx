    ...
    <aside className="w-16 lg:w-56 bg-card border-r border-border flex flex-col min-h-screen shrink-0">
      <div className="p-3 lg:p-4 flex items-center justify-center lg:justify-start">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-8 h-8 bg-gradient-to-br from-[#6366F1] to-[#8B5CF6] rounded-lg flex items-center justify-center shadow-lg shadow-purple-500/20">
            <Zap className="w-4 h-4 text-white" />
          </div>
          <span className="hidden lg:block text-base font-bold bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] bg-clip-text text-transparent">SiteForge</span>
        </Link>
      </div>
      ...
      <div className="p-2 lg:p-3 border-t border-border">
        <div className="flex items-center justify-center lg:justify-start gap-2 px-2 py-2">
          <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#6366F1] to-[#8B5CF6] flex items-center justify-center text-xs font-bold text-white shrink-0">
